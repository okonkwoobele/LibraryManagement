    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('genre', models.CharField(choices=[('FICTION', 'FIC'), ('POLITICS', 'POL'), ('FINANCE', 'FIN'), ('ROMANCE', 'ROM')], max_length=10)),
                ('language', models.CharField(choices=[('YORUBA', 'Y'), ('HAUSA', 'H'), ('IGBO', 'I'), ('ENGLISH', 'E')], max_length=10)),
